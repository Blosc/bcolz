...
class createTest(MayBeDiskTest):
    ...
    def test00b(self):
        ...
        t = bcolz.ctable(([1,2,3],[4,5,6]), ('f0', 'f1'), rootdir=self.rootdir)
        #print "t->", `t`
    ...
    def test00c(self):
        ...
        N = 1e1
        a = bcolz.carray(np.arange(N, dtype='i4'))
        self.assertRaises(ValueError, bcolz.ctable, a, 'f0', rootdir=self.rootdir)
    ...
    def test03a(self):
        ...
        N = 10*1000
        ra = np.fromiter(((i, i*2.) for i in xrange(N)), dtype='i4,f8')
        t = bcolz.fromiter(((i, i*2.) for i in xrange(N)), dtype='i4,f8',
