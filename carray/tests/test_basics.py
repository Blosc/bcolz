...
class carrayCheck(unittest.TestCase):
...
class earrayCheck(unittest.TestCase):
...
def suite():
    ...
    theSuite.addTest(unittest.makeSuite(carrayCheck))
    theSuite.addTest(unittest.makeSuite(earrayCheck))
