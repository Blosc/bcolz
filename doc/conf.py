# -*- coding: utf-8 -*-
#
# bcolz documentation build configuration file, created by
...
project = u'bcolz'
copyright = u'2010-2015 Francesc Alted and the bcolz contributors'
...
# howto/manual]).
latex_documents = [
    ('index', 'bcolz.tex', u'bcolz Documentation',
...
man_pages = [
    ('index', 'bcolz', u'bcolz Documentation',
     [u'Francesc Alted'], 1)
]
